        ...
        <footer class="footer">
                    ...
                    <div class="row">
                        <div class="col-sm-2 sm-margin-b-50">
                            ...
                            <ul class="list-unstyled footer-list">
                                ...
                                <li class="footer-list-item"><a class="footer-list-link" href="#">Our Team</a></li>

                                  <?php foreach($pages as $k => $v){ ?>
                                 <li class="footer-list-item"><a class="footer-list-link" href="<?php echo rooturl;?>page.php?id=<?php echo $v['pages_id']?>"><?php echo $v['pages_name'];?></a></li>
                                <?php } ?>
                        ...
                        <div class="col-sm-4 sm-margin-b-30">
                            <!-- List -->
                            <ul class="list-unstyled footer-list">
                                <li class="footer-list-item"><a class="footer-list-link" href="http://facebook.com">Facebook</a></li>
                                <li class="footer-list-item"><a class="footer-list-link" href="http://linkedin.com">LinkedIn</a></li>
                            </ul>
                            <!-- End List -->
                        </div>
            ...
            <div class="content container">
                <div class="row">
                    <div class="col-xs-6">
                      <p style = 'color:#fff;'>Technocorp</p>
                    </div>
